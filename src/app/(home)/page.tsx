...
import MySearch from "@/components/ui/layout/Header/Search";


type Props = {
  searchParams: {
    type: string, page: string,modelname: string,price: string,
  }
}
    ...
    <main className="min-h-screen">
      ...
      <section className="relative h-[500px] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <MySearch searchParams={searchParams}/>
        </div>
...
const price = searchParams.price || '';
   const cars = await getCars({ page, type,modelname,price });
  //  const cars = []
