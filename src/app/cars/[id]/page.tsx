...
import { getAllCars, getCarById, getSellerInfo } from "@/lib/actions/cars.action";
import { Image } from "@imagekit/next";
import { Clock, Gauge, MapPin, Shield, PenTool as Tool, } from "lucide-react";
        ...
        <div className="lg:col-span-2">
            <Card className="mb-8">
                <CardContent className="p-6">
                    ...
                    <ScrollArea>
                        <div className="flex gap-2 pt-[18rem]">
